                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="activity">
                                <h3 class="text-center">Mostrar actividad del usuario - {{empresa}}</h3>
                            </div>
                            <!-- Setting Tab -->
                            <div class="tab-pane active show" id="settings">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                        <input type="" v-model="form.rfc" class="form-control" id="inputRFC" placeholder="RFC" :class="{ 'is-invalid': form.errors.has('rfc') }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                        <input type="email" v-model="form.correo" class="form-control" id="inputEmail" placeholder="Email"  :class="{ 'is-invalid': form.errors.has('email') }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea  v-model="form.direccion" class="form-control" id="inputDireccion" placeholder="Nombre de usuario" :class="{ 'is-invalid': form.errors.has('bio') }"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                        <input type="" v-model="form.telefono" class="form-control" id="inputTelefono" placeholder="Teléfono" :class="{ 'is-invalid': form.errors.has('telefono') }">
...
<script>
    export default {
        ...
        methods:{
            cargarEmpresas(){
                axios.get("../api/empresa"+"/"+this.empresa).then(({data}) => (this.form.fill(data)));
