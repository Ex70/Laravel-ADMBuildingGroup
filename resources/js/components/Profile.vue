                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group">
                                    <label for="inputExperience" class="col-sm-2 control-label">Nombre de usuario</label>

                                    <div class="col-sm-12">
                                    <textarea  v-model="form.usuario" class="form-control" id="inputUsuario" placeholder="Nombre de usuario" :class="{ 'is-invalid': form.errors.has('bio') }"></textarea>
                                     <has-error :form="form" field="usuario"></has-error>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="photo" class="col-sm-2 control-label">Imagen de perfil</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="password" class="col-sm-12 control-label">Contraseña (Dejar vacío si no requiere cambio)</label>
