...
Route::get('findState','API\EstadoController@search');
Route::get('findModulo','API\ModuloController@search');
Route::get('findCity','API\CiudadController@search');
Route::get('findCompany','API\EmpresaController@search');
